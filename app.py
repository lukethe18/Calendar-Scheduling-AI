    ...
    if request.method == "POST":
        if form.validate_on_submit():
            ...
            try:
                ...
                4. Return the start and end date/time in ISO 8601 format (YYYY-MM-DDTHH:MM:SSZ) *in UTC*
                5. Convert the user's local timezone to UTC.  
                ...
                Relative Date/Time Calculation and UTC Conversion with Date Rollover:
                ...
                *   When converting times to UTC, pay close attention to date rollover.  If a time in the user's local time converts to a time on the *next day* in UTC, make sure the date in the ISO 8601 string reflects this.
                *   If a time range spans across midnight (e.g., "from 8 PM to 1 AM"), the end date *must* be the day *after* the start date.
               
                
                Example 1:
                User input: Meeting from 9am to 10am
                AI response: Summary: Meeting Start: 2024-10-30T14:00:00Z End: 2024-10-30T15:00:00Z

                Example 2:
                User input: Meeting from 8 to 6
                AI response: Summary: Meeting Start: 2024-10-30T13:00:00Z End: 2024-10-31T01:00:00Z

                Example 3:
                User input: Meeting tomorrow at 2
                AI response: Summary: Meeting Start: 2024-10-31T07:00:00Z End: 2024-10-31T08:00:00Z

                Example 4:
                User input: Josh's Birthday on 2/20/2025
                AI Response: Summary: Josh's Birthday Start: 2025-02-20T00:00:00Z End: 2025-02-21T00:00:00Z All Day Event: true

                Example 6:
                User input: Meeting next Tuesday from 11 to 6
                AI response: Summary: Meeting Start: 2024-11-05T16:00:00Z End: 2024-11-06T00:00:00Z

                Example 7:
                User input: Meeting from noon to 7
                AI response: Summary: Meeting Start: 2024-10-31T17:00:00Z End: 2024-11-01T02:00:00Z

                Example 8:
                User input: Party next Wednesday from 8 to 1 am
                AI response: Summary: Party Start: 2024-11-06T01:00:00Z End: 2024-11-07T06:00:00Z
                """ 

                response = openai.chat.completions.create(
                    model="gpt-4o-mini-2024-07-18",
                    messages=[
                     {"role": "system", "content": "You are a helpful calendar assistant. Return the following information: Summary: [summary] Location:[location] Description: [description] Start: [ISO 8601 UTC start time] End: [ISO 8601 UTC end time] All Day Event: [true or false]"},
